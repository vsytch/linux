...
{
	printk("KCS: 0Ch: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x0C));
	printk("KCS: 0Eh: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x0E));
	printk("KCS: 10h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x10));
	printk("KCS: 12h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x12));
	printk("KCS: 14h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x14));
	printk("KCS: 16h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x16));
	printk("KCS: 18h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x18));
	printk("KCS: 1Ah: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x1A));
	printk("KCS: 1Ch: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x1C));
  printk("BIOS:42h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x42));
  printk("BIOS:44h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x44));
  printk("BIOS:46h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x46));
  printk("BIOS:48h: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x48));
  printk("BIOS:4Ah: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x4A));
  printk("BIOS:4Ch: %x\n",*((u8 *)LPC_REG_BASE_ADDR+0x4C));
...
{   
	...
	switch(cmd)
	{
		...
		case AESS_KCSDRV_READ:
            {
                u8 Data[KCS_PACKAGE_MAX];
                u8 *Data_orig = psInfo->pu8Data;
                psInfo->pu8Data = Data;
...
static void aess_kcs_setstate(u8 u8Channel, u8 u8State)
{
