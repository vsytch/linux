...
#define PCIE_VDM_SET_TRANSMIT_BUFFER_SIZE   _IOW(PCIE_VDM_IOC_MAGIC, 2 , u32_t )
#define PCIE_VDM_SET_RECEIVE_BUFFER_SIZE    _IOW(PCIE_VDM_IOC_MAGIC, 3 , u32_t )
...
#define PCIE_VDM_SET_RX_TIMEOUT 			_IOW(PCIE_VDM_IOC_MAGIC, 8 , u32_t )
#define PCIE_VDM_REINIT						_IOW(PCIE_VDM_IOC_MAGIC, 9 , u32_t )
#define PCIE_VDM_SET_RESET_DETECT_POLL		_IOW(PCIE_VDM_IOC_MAGIC, 10 , u32_t )
#define PCIE_VDM_GET_ERRORS					_IOW(PCIE_VDM_IOC_MAGIC, 11 , u32_t *)
#define PCIE_VDM_CLEAR_ERRORS				_IOW(PCIE_VDM_IOC_MAGIC, 12 , u32_t )
