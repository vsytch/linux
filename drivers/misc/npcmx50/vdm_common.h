...
/******** vdm module defines **************/
#define PHY_SELECT_FOR_PCIE_BRIDGE_REG   (NPCMX50_GCR_BASE_ADDR + 0x64), NPCMX50_VDM_ACCESS, 32
#define PHY_SELECT_FOR_PCIE_BRIDGE_FIELD_POS   (17)

#define PHYS_VDM_STAT_REG_ADDR		(NPCMX50_VDM_PHYS_BASE_ADDR + 0x00)
#define VDM_STAT_REG_ADDR			(NPCMX50_VDM_BASE_ADDR + 0x00)
#define VDM_STAT_REG				(VDM_STAT_REG_ADDR), NPCMX50_VDM_ACCESS, 32
...
#define VDM_INT_EN_REG				(NPCMX50_VDM_BASE_ADDR + 0x04), NPCMX50_VDM_ACCESS, 32
#define VDM_INT_EN_REG_RX_INT_BIT_POS   		1

#define PHYS_VDM_RXF_REG_ADDR		(NPCMX50_VDM_PHYS_BASE_ADDR + 0x08)
#define VDM_RXF_REG_ADDR			(NPCMX50_VDM_BASE_ADDR + 0x08)
#define VDM_RXF_REG					(VDM_RXF_REG_ADDR), NPCMX50_VDM_ACCESS, 32

#define VDM_TXF_REG					(NPCMX50_VDM_BASE_ADDR + 0x0c), NPCMX50_VDM_ACCESS, 32

#define VDM_CNT_REG_ADDR			(NPCMX50_VDM_BASE_ADDR + 0x10)
#define VDM_CNT_REG					(VDM_CNT_REG_ADDR), NPCMX50_VDM_ACCESS, 32
...
#define VDM_FLT_REG					(NPCMX50_VDM_BASE_ADDR + 0x14), NPCMX50_VDM_ACCESS, 32
#define VDM_FLT_REG_FLT_ENABLE_BIT_POS			31



/******** vdma module defines **************/
#define VDMA_CNT_REG				(NPCMX50_VDMA_BASE_ADDR + 0x00), NPCMX50_VDM_ACCESS, 32
#define VDMA_CNT_REG_BUS_LOCK_BIT_POS 						17
#define VDMA_CNT_REG_BURST_BIT_POS 							9
#define VDMA_CNT_REG_ENABLE_POS 							0


#define VDMA_SRCB_REG				(NPCMX50_VDMA_BASE_ADDR + 0x04), NPCMX50_VDM_ACCESS, 32
#define VDMA_DSTB_REG				(NPCMX50_VDMA_BASE_ADDR + 0x08), NPCMX50_VDM_ACCESS, 32
#define VDMA_CDST_REG				(NPCMX50_VDMA_BASE_ADDR + 0x14), NPCMX50_VDM_ACCESS, 32

#define VDMA_ERDPNT_REG				(NPCMX50_VDMA_BASE_ADDR + 0x48), NPCMX50_VDM_ACCESS, 32

#define VDMA_ECTL_REG				(NPCMX50_VDMA_BASE_ADDR + 0x40), NPCMX50_VDM_ACCESS, 32
...
#define VDMA_ESRCSZ_REG				(NPCMX50_VDMA_BASE_ADDR + 0x44), NPCMX50_VDM_ACCESS, 32

#define VDMA_EST0AD_REG				(NPCMX50_VDMA_BASE_ADDR + 0x50), NPCMX50_VDM_ACCESS, 32
#define VDMA_EST0MK_REG				(NPCMX50_VDMA_BASE_ADDR + 0x54), NPCMX50_VDM_ACCESS, 32
#define VDMA_EST0DT_REG				(NPCMX50_VDMA_BASE_ADDR + 0x58), NPCMX50_VDM_ACCESS, 32
