...
/**************************************************************************************************************************/
#define  FCTL(n)                         (otp_base[n] + 0x14) , NPCMX50_FUSE_OTP_ACCESS, 32       /* Location: BASE+14h */
...
/**************************************************************************************************************************/
#define  FST(n)                          (otp_base[n] + 0x00) , NPCMX50_FUSE_OTP_ACCESS, 32       /* Location: BASE+00h */
...
/**************************************************************************************************************************/
#define  FADDR(n)                        (otp_base[n] + 0x04) , NPCMX50_FUSE_OTP_ACCESS, 32       /* Location: BASE+04h */
...
/**************************************************************************************************************************/
#define  FDATA(n)                        (otp_base[n] + 0x08) , NPCMX50_FUSE_OTP_ACCESS, 32       /* Location: BASE+08h */
...
/**************************************************************************************************************************/
#define  FCFG(n)                         (otp_base[n] + 0x0C) , NPCMX50_FUSE_OTP_ACCESS, 32       /* Location: BASE+0Ch */
...
/**************************************************************************************************************************/
#define  FKEYIND                        (otp_base[0] + 0x10) , NPCMX50_FUSE_OTP_ACCESS, 32        /* Location: BASE+10h */
...
/**************************************************************************************************************************/
#define  FUSTRAP                        (otp_base[1] + 0x10) , NPCMX50_FUSE_OTP_ACCESS, 32        /* Location: BASE+10h */
