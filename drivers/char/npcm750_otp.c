...
static UINT           NPCM750_OTP_Fustrap_Get               (NPCM750_OTP_FUSTRAP_FIELDS_T oFuse); // TODO: is this needed for Linux? 
...
/*---------------------------------------------------------------------------------------------------------*/
static UINT           NPCM750_OTP_Fustrap_Get (NPCM750_OTP_FUSTRAP_FIELDS_T oFuse)
{
    UINT retVal = 0;
    switch (oFuse)
    {
