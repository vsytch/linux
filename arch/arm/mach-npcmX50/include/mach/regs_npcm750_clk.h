...
#ifndef _NPCMX50_CLK_REGS_H
#define _NPCMX50_CLK_REGS_H
...
/**************************************************************************************************************************/
#define  CLKEN1                         (CLK_VIRT_BASE_ADDR + 0x00) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKEN2                         (CLK_VIRT_BASE_ADDR + 0x28) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKEN3                         (CLK_VIRT_BASE_ADDR + 0x30) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKSEL                         (CLK_VIRT_BASE_ADDR + 0x04) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKDIV1                        (CLK_VIRT_BASE_ADDR + 0x08) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKDIV2                        (CLK_VIRT_BASE_ADDR + 0x2C) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CLKDIV3                        (CLK_VIRT_BASE_ADDR + 0x58) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  PLLCON0                        (CLK_VIRT_BASE_ADDR + 0x0C) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   PLL Control Register 1 (PLLCON1)                                                                                     */
/**************************************************************************************************************************/
#define  PLLCON1                        (CLK_VIRT_BASE_ADDR + 0x10) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   PLL Control Register 2 (PLLCON2) (New in Poleg)                                                                      */
/**************************************************************************************************************************/
#define  PLLCON2                        (CLK_VIRT_BASE_ADDR + 0x54) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  SWRSTR                         (CLK_VIRT_BASE_ADDR + 0x14) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  IRQWAKECON                     (CLK_VIRT_BASE_ADDR + 0x18) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  IRQWAKEFLAG                    (CLK_VIRT_BASE_ADDR + 0x1C) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  IPSRST1                        (CLK_VIRT_BASE_ADDR + 0x20) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  IPSRST2                        (CLK_VIRT_BASE_ADDR + 0x24) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  IPSRST3                        (CLK_VIRT_BASE_ADDR + 0x34) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  WD0RCR                         (CLK_VIRT_BASE_ADDR + 0x38) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  WD1RCR                         (CLK_VIRT_BASE_ADDR + 0x3C) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   Watchdog 2 Reset Control Register (WD2RCR) (New in )                                                                 */
/**************************************************************************************************************************/
#define  WD2RCR                         (CLK_VIRT_BASE_ADDR + 0x40) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   Software Reset Control Register 1 (SWRSTC1) (New in )                                                                */
/**************************************************************************************************************************/
#define  SWRSTC1                        (CLK_VIRT_BASE_ADDR + 0x44) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   Software Reset Control Register 2 (SWRSTC2) (New in )                                                                */
/**************************************************************************************************************************/
#define  SWRSTC2                        (CLK_VIRT_BASE_ADDR + 0x48) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   Software Reset Control Register 3 (SWRSTC3) (New in )                                                                */
/**************************************************************************************************************************/
#define  SWRSTC3                        (CLK_VIRT_BASE_ADDR + 0x4C) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   Software Reset Control Register 4 (SWRSTC4) (New in )                                                                */
/**************************************************************************************************************************/
#define  SWRSTC4                        (CLK_VIRT_BASE_ADDR + 0x50) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   CORST Control Register (CORSTC) (New in )                                                                            */
/**************************************************************************************************************************/
#define  CORSTC                         (CLK_VIRT_BASE_ADDR + 0x5C) , NPCMX50_CLK_ACCESS, 32

/**************************************************************************************************************************/
/*   PLL Control Register GFX (PLLCONG) (New in )                                                                         */
/**************************************************************************************************************************/
#define  PLLCONG                        (CLK_VIRT_BASE_ADDR + 0x60) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  AHBCKFI                        (CLK_VIRT_BASE_ADDR + 0x64) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  SECCNT                         (CLK_VIRT_BASE_ADDR + 0x68) , NPCMX50_CLK_ACCESS, 32
...
/**************************************************************************************************************************/
#define  CNTR25M                         (CLK_VIRT_BASE_ADDR + 0x6C) , NPCMX50_CLK_ACCESS, 32
...
#define  CNTR25M_ACCURECY                 NPCMX50_EXT_CLOCK_FREQUENCY_MHZ  /* minimum accurecy 1us which is 5 cycles */
