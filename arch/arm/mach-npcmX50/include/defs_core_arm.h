...
/*---------------------------------------------------------------------------------------------------------*/
    ...
    /*-----------------------------------------------------------------------------------------------------*/
        ...
        /* CPU power management                                                                            */
        /*-------------------------------------------------------------------------------------------------*/
        #if defined (__TARGET_ARCH_4)   || defined (__TARGET_ARCH_4T) || defined (__TARGET_ARCH_5T) || defined (__TARGET_ARCH_5TE) || \
            defined (__TARGET_ARCH_5TEJ)|| defined (__TARGET_ARCH_6)  || defined (__TARGET_ARCH_6_M)|| defined (__TARGET_ARCH_6S_M)|| \
            defined (__TARGET_ARCH_6K)  || defined (__TARGET_ARCH_6T2)|| defined (__TARGET_ARCH_6Z) || defined (__ARM_ARCH_7J__)
...
/*---------------------------------------------------------------------------------------------------------*/
    ...
    /*-----------------------------------------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------------------------------------*/
        #if defined (__ARM_ARCH_2__)   || defined (__ARM_ARCH_3__)   || defined (__ARM_ARCH_3M__)  || defined (__ARM_ARCH_4__)   || \
            defined (__ARM_ARCH_4T__)  || defined (__ARM_ARCH_5T__)  || defined (__ARM_ARCH_5TE__) || defined (__ARM_ARCH_5TEJ__)|| \
            defined (__ARM_ARCH_6J__)  || (__ARM_ARCH_7J__)
            /*---------------------------------------------------------------------------------------------*/
            /* Not supported by architecture with Thumb instructions                                       */
            /*---------------------------------------------------------------------------------------------*/
            #define CPU_IDLE()

        #elif defined (__ARM_ARCH_6_M__) || defined (__ARM_ARCH_6__)  || defined (__ARM_ARCH_6S_M__) ||                     \
        ...
        /* Interrrupt macros                                                                               */
        /*-------------------------------------------------------------------------------------------------*/
        #if defined (__ARM_ARCH_4__) || defined (__ARM_ARCH_4T__) || defined (__ARM_ARCH_5T__) || defined (__ARM_ARCH_5TE__) || defined (__ARM_ARCH_5TEJ__)

            /*---------------------------------------------------------------------------------------------*/
            /* Not supported with Thumb instructions                                                       */
            /*---------------------------------------------------------------------------------------------*/

        #elif defined (__ARM_ARCH_6J__) || defined (__ARM_ARCH_6ZK__)  || defined (__ARM_ARCH_7J__)
            /*---------------------------------------------------------------------------------------------*/
        ...
        /*-------------------------------------------------------------------------------------------------*/
        #if defined (__ARM_ARCH_2__)  || defined (__ARM_ARCH_3__)   || defined (__ARM_ARCH_3M__) || defined (__ARM_ARCH_4__)    ||  \
            defined (__ARM_ARCH_4T__) || defined (__ARM_ARCH_5TE__) || defined (__ARM_ARCH_5T__) || defined (__ARM_ARCH_5TEJ__ )||  \
            defined (__ARM_ARCH_6J__) || defined (__ARM_ARCH_6ZK__) || defined (__ARM_ARCH_6K__) || defined (__ARM_ARCH_6M__)  || defined (__ARM_ARCH_7J__)
            /*---------------------------------------------------------------------------------------------*/
        ...
        #if defined (__ARM_ARCH_2__)   || defined (__ARM_ARCH_3__)   || defined (__ARM_ARCH_3M__)   || defined (__ARM_ARCH_4__)   ||\
            defined (__ARM_ARCH_4T__)  || defined (__ARM_ARCH_5T__)  || defined (__ARM_ARCH_5TE__)  || defined (__ARM_ARCH_5TEJ__)||\
            defined (__ARM_ARCH_6_M__) || defined (__ARM_ARCH_6__)   || defined (__ARM_ARCH_6S_M__) || defined (__ARM_ARCH_6J__)  ||\
            defined (__ARM_ARCH_6T2__)  || defined (__ARM_ARCH_7J__)
            #define CPU_IDLE()                          __asm   __volatile__ (                              \
                                                                                "MOV r0, #0 \n\t"           \
                                                                                "MCR p15, 0, r0, c7, c0, 4" \
                                                                                ::: "r0", "cc" )
